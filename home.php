...
<html lang="en">
   ...
   <body>
         ...
         <div class="header_bg">
            <div class="container">
               <nav class="navbar navbar-expand-lg navbar-light bg-light">
                  <a class="logo" href="index.html"><h1>BookShop</h1></a>
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="navbar-nav mr-auto">
                        <li class="nav-item active">
                           <a class="nav-link" href="master.php">Home</a>
                        </li>
                        <li class="nav-item">
               ...
               <div class="carousel-item active">
                  <div class="container">
                     <div class="banner_taital_main">
                        <div class="row">
                           <div class="col-md-6">
                              <h1 class="banner_taital">Hello, <?php echo $_SESSION['name']; ?> Welcome again</h1>
                              <p class="banner_text">Get your favorite Book for your reading</p>
                              <div class="btn_main">
      ...
      <div class="blog_section layout_padding">
         <div class="container">
            <h1 class="news_taital">Our Books</h1>
            <p class="news_text">Best reading books with good price </p>
            <div class="blog_section_2">
               <div class="row">
                  ...
                  <div class="col-md-6">
                     <h4 class="classes_text">Best study book</h4>
                     <p class="ipsum_text">The Power of Positive Thinking  </p>
                  </div>
               </div>
            </div>
